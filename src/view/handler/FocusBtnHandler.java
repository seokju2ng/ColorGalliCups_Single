...
/**
 * 게임 플레이 UI(SinglePlayMode, DualPlayMode)에서 버튼 클릭 시 버튼으로 옮겨진 포커스를 현재 패널로 옮겨준다.
 * @author cms<br>*/
public class FocusBtnHandler implements ActionListener{
	/**게임 플레이 UI(SinglePlayMode, DualPlayMode) 중 하나의 JPanel이다.*/
	private JPanel panel;
	/**FocusBtnHandler의 생성자로 panel를 parameter로 받아 객체를 생성한다.
	 * @param panel 게임 플레이 UI(SinglePlayMode, DualPlayMode) 중 하나의 JPanel이다.*/
