package model;
/**
 * Option 설정을 위한 Model Entity Bean Class이다. 멤버 필드로는 배경음악, 효과음, 카드 숫자가 있다.
 * @author seokjung
 *
 */
public class Option {
	...
	/**
	 * Copy Constructor이다.
	 * Option 객체를 전달인자로 주었을 때 값을 복사해 생성해주는 복사 생성자이다.
	 * @param op 복사할 Option 객체이다.
	 */
	...
	/**
	 * Option 클래스의 멤버 필드의 값을 모두 String으로 변환시켜 반환한다. 
	 * @return Option 클래스의 멤버 필드의 값을 모두 String으로 변환시켜 반환한다.
	 */
