...
/**
 * 랭크정보 클래스이다. 기본적인 메소드만 가지고 있으며 RankDao에서 사용할 랭크정보(순위, 이름, 점수)를 저장하는 클래스이다.
 * 
 * @author 송준희
 */
public class Rank {
	...
	/**
	 * null-parameter Constructor 랭크정보 클래스의 생성자로 사용자의 순위, 이름, 점수를 default값으로 초기화한
	 * 랭크정보 객체를 할당해준다.
	 */
	public Rank() {
	}
	 ...
	 * 
	 * @param ranking
	 *            랭크정보 클래스에서 사용자의 순위에 해당하는 값이다.
	 * @param name
	 *            랭크정보 클래스 사용자의 이름에 해당하는 값이다.
	 * @param score
	 *            랭크정보 클래스에서 사용자의 점수에 해당하는 값이다.
	 */
	 ...
	 * 
	 * @param rank
	 *            랭크정보 클래스에서 사용자의 랭크 정보에 해당하는 값이다.
	 */
	 ...
	 * 
	 * @return 랭크정보 객체의 사용자의 순위, 이름, 점수를 String 타입으로 반환하여 리턴한다.
	 */
